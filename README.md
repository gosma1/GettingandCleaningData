...
The Script assumes that the data has already been downloaded and it is available in the same directory as the script, but there is additional code (currently commented) that downloads the required data.
